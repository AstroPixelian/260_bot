...
## Tasks / Subtasks
- [ ] Task 1: Create Playwright automation interface in AutomationService (AC: 1, 2)
  - [ ] Add Playwright dependency import and browser management 
  - [ ] Create `register_single_account` method in AutomationService
  - [ ] Add browser launch configuration and context management
  - [ ] Implement error handling for browser operations

- [ ] Task 2: Implement 360.cn registration page navigation and interaction (AC: 2, 3, 4)
  - [ ] Navigate to `https://wan.360.cn/` and wait for page load
  - [ ] Click registration button: `/html/body/div/div/div[2]/div/div/div/div[2]/form/div[6]/div[2]/a[1]`
  - [ ] Wait for registration modal to appear and be ready for interaction
  - [ ] Fill username input: `/html/body/div[9]/div[2]/div/div/div/form/div[1]/div/div[1]/div/div/input`
  - [ ] Fill password input: `/html/body/div[9]/div[2]/div/div/div/form/div[1]/div/div[2]/div/div/input`
  - [ ] Fill confirm password input: `/html/body/div[9]/div[2]/div/div/div/form/div[1]/div/div[3]/div/div/input`
  - [ ] Check registration terms agreement: `/html/body/div[9]/div[2]/div/div/div/form/div[2]/label/input`
  - [ ] Click confirm registration button: `/html/body/div[9]/div[2]/div/div/div/form/div[3]/input`
  - [ ] Wait for registration processing and verify success by checking logout link: `/html/body/div[1]/div/span[2]/a[2]` contains `[退出]`

- [ ] Task 3: Integrate with existing Account model and status management (AC: 1)
  - [ ] Update Account model to support registration result tracking
  - [ ] Implement status updates during registration process (processing → success/failed)
  - [ ] Add error message capture and notes field updates
  - [ ] Ensure proper cleanup of browser resources

- [ ] Task 5: Integrate with AccountGenerator for testing data (Testing Requirements)
  - [ ] Reference existing `src/account_generator.py` for test account generation
  - [ ] Ensure generated accounts are compatible with 360.cn requirements
  - [ ] Add integration test that uses AccountGenerator data for real registration testing
  - [ ] Document account generation usage in test files

- [ ] Task 6: Add unit tests for registration logic (Testing Requirements)
  - [ ] Create test file `tests/unit/test_automation_service_registration.py`
  - [ ] Mock Playwright operations for isolated testing
  - [ ] Test success and failure scenarios
  - [ ] Test error handling and cleanup

- [ ] Task 7: Add integration test for end-to-end registration flow (Testing Requirements)
  - [ ] Create test file `tests/integration/test_registration_e2e.py`
  - [ ] Test actual browser automation (with test credentials)
  - [ ] Verify account status transitions
